...
const Accept = () => {
  ...
  const historyItems = [
    { event: 'Order Delivered', timestamp: '2024-11-17', completed: false, path: '/order-details/delivered' },
    { event: 'On Delivery', timestamp: '2024-11-16', completed: false, path: '/order-details/on-delivery' },
    { event: 'Payment Success', timestamp: '2024-11-15', completed: false, path: '/order-details/payment-success' },
    { event: 'Order Created', timestamp: '2024-11-14', completed: false, path: '/order-details/created' },
    { event: 'Accepted', timestamp: '2024-11-13', completed: true, path: '/order-details' },
  ];
  ...
  return (
    ...
    >
      <div className="space-y-6 w-full">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <ul className="mt-4 space-y-6 relative">
                {historyItems.map((item, index) => (
                  <li
                    key={index}
                    className="flex items-start space-x-4 relative cursor-pointer"
        ...
        {/* Display MapSection only on Accept Page */}
        <MapSection />
      </div>
    </div>
  );
